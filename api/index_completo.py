...
IMPORTANT: Handle ALL types of requests:
- Regular weekly schedules (Monday-Friday 9am-5pm)
- Blocked dates (vacations, conferences, specific weeks)
- Day-specific hours (Saturday 8am-12pm, weekday 9am-5pm)
- Partial day blocks (no Tuesday afternoons, Friday only until noon)
...
{{
  "schedule": {{
    ...
    "blocked_dates": ["2026-03-17", "2026-03-18", "2026-12-25"],
    "blocked_date_ranges": [
...
- If text mentions weeks (third week of March), calculate exact dates
- If text says "block", "vacation", "conference", "not available" - add to blocked_dates
